...
del /q/f *.asm
del /q/f *.cfg
node_0.12.4_x86.exe --trace-hydrogen --trace-phase=Z --trace-deopt --code-comments --hydrogen-track-positions  --redirect-code-traces --redirect-code-traces-to=code.asm --print_deopt_stress _build/demo.js
rem 
